...
export default function Careers() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h1 className="text-4xl font-bold text-green-700 mb-6">Careers at RePack</h1>

      <p className="text-gray-700 text-lg leading-relaxed">
        Join our passionate team on a mission to create a sustainable, reusable packaging future. At RePack, we believe that innovation and impact go hand-in-hand.
      </p>
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-700 mb-4">
          We're always looking for great minds in design, development, marketing, and operations. Send your resume or portfolio to <a href="mailto:careers@repack.com" className="text-green-700 underline">careers@repack.com</a>
        </p>
